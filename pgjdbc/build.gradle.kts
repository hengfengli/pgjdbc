...
tasks.test {
    ...
    // skip advanced tests
    exclude("**/*CopyTest*")
    exclude("**/*OidValuesCorrectnessTest*")
    exclude("**/*BitFieldTest*")
    exclude("**/*DeepBatchedInsertStatementTest*")
    exclude("**/*LargeObjectManagerTest*")
    exclude("**/*ScramTest*")
    exclude("**/*BatchFailureTest*")
    exclude("**/*BatchedInsertReWriteEnabledTest*")
    exclude("**/*BlobTest*")
    exclude("**/*BlobTransactionTest*")
    exclude("**/*CallableStmtTest*")
    exclude("**/*ClientEncodingTest*")
    exclude("**/*ConcurrentStatementFetch*")
    exclude("**/*CopyLargeFileTest*")
    exclude("**/*CustomTypeWithBinaryTransferTest*")
    exclude("**/*DatabaseEncodingTest*")
    exclude("**/*DatabaseMetaDataCacheTest*")
    ...
    exclude("**/*ParameterStatusTest*")
    exclude("**/*RefCursorFetchTest*")
    exclude("**/*RefCursorTest*")
    exclude("**/*ResultSetRefreshTest*")
    exclude("**/*ServerCursorTest*")
    exclude("**/*ServerErrorTest*")
    exclude("**/*ServerPreparedStmtTest*")
    exclude("**/*TimezoneCachingTest*")
