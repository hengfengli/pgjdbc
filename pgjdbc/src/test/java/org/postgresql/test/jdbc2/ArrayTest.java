...
public class ArrayTest extends BaseTest4 {
  ...
  public void setUp() throws Exception {
    super.setUp();
    conn = con;
    conn.createStatement().execute("set spanner.support_drop_cascade to on");
    TestUtil.createTable(conn, "arrtest", "intarr int[], decarr decimal[], strarr text[], id bigint generated by default as identity (bit_reversed_positive) primary key");
  }
