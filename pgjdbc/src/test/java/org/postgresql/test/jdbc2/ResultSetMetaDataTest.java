...
public class ResultSetMetaDataTest extends BaseTest4 {
  ...
  public void setUp() throws Exception {
    super.setUp();
    conn = con;
    TestUtil.createTable(conn, "rsmd1", "a int primary key, b text, c decimal");
    ...
    if (TestUtil.haveMinimumServerVersion(conn, ServerVersion.v10)) {
      TestUtil.createTable(conn, "identitytest", "id bigint GENERATED BY DEFAULT AS IDENTITY (bit_reversed_positive) PRIMARY KEY");
    }

    TestUtil.createTable(conn, "serialtest", "a id bigint GENERATED BY DEFAULT AS IDENTITY (bit_reversed_positive), b id bigint GENERATED BY DEFAULT AS IDENTITY (bit_reversed_positive), c int, id bigint GENERATED BY DEFAULT AS IDENTITY (bit_reversed_positive) PRIMARY KEY");
