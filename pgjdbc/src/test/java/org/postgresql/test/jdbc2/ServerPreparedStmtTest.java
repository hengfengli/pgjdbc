...
public class ServerPreparedStmtTest extends BaseTest4 {
  ...
  public void setUp() throws Exception {
    ...
    TestUtil.createTable(con, "testsps", "id integer primary key, value boolean");
  ...
  public void testBytea() throws Exception {
    ...
    try {
      TestUtil.createTable(con, "testsps_bytea", "data bytea, id bigint generated by default as identity (bit_reversed_positive) primary key");
  ...
  public void testMultistatement() throws Exception {
    ...
    try {
      TestUtil.createTable(con, "testsps_multiple", "data int, id bigint generated by default as identity (bit_reversed_positive) primary key");
