...
public class PreparedStatementTest extends BaseTest4 {
  ...
  public void setUp() throws Exception {
    super.setUp();
    TestUtil.createTable(con, "timestamptztable", "id bigint generated by default as identity (bit_reversed_positive) primary key, tstz timestamptz");
    TestUtil.createTable(con, "timetztable", "id bigint generated by default as identity (bit_reversed_positive) primary key, ttz timetz");
    TestUtil.createTable(con, "timetable", "id bigint generated by default as identity (bit_reversed_positive) primary key, tt time");
  }
